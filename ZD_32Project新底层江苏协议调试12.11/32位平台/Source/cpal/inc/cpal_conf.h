...
#ifndef CPAL_CPAL_CONF_H
#define CPAL_CPAL_CONF_H
...
/*============================ MACROS ========================================*/
//! @defgroup CONF_Private_TypesDefinitions
//! @{
/*=======================================================================================================================================
...
#if defined (USE_STM32L152_EVAL) || defined (USE_STM32L152D_EVAL) || defined (USE_STM3210C_EVAL) || defined (STM32F10X_HD) || defined (USE_STM322xG_EVAL) || defined (USE_STM324xG_EVAL)
...
#define _CPAL_TIMEOUT_INIT() 		   SVIC[0].SetVectForSystick(true, CPAL_I2C_TIMEOUT_Manager);
...
#define _CPAL_TIMEOUT_DEINIT()         SVIC[0].SetVectForSystick(false, CPAL_I2C_TIMEOUT_Manager);
									   //CPAL_I2C_Timeout_Flag = false
...
//! \name conf configuration structure
//! @{
//! @}


/*============================ INTERFACE =====================================*/
//! \brief Macro for conf interface function prototypes        
//!
...
/*============================ PROTOTYPES ====================================*/
//! \brief conf interface function prototypes
